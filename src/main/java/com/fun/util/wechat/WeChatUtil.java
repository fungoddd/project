...
/**
 * @Author: FunGod
 * @Date: 2018-12-07 11:23:37
 * @Desc: 微信公众平台接口工具类, 主要用来提交https请求给微信获取用户信息
 */
public class WeChatUtil {
    ...
    /**
     * 获取UserAccessToken实体类,使用code换取用户access_token
     *
     * @param code
     * @return
     * @throws IOException
    ...
    public static UserAccessToken getUserAccessToken(String code) throws IOException {
        // 测试号信息里的appId
        String appId = "wx09656c4475dbc253";
        log.debug("appId:" + appId);

        // 测试号信息里的appsecret
        String appsecret = "a5341be018a639f33b65474f06221380";
    ...
    public static WeChatUser getUserInfo(String accessToken, String openId) {
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        try {
            // 将前端请求传来的json字符串(用户的信息),转换成相应对象(微信用户对象)
